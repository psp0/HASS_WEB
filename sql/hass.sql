...
ALTER TABLE CUSTOMER_AUTH ADD CONSTRAINT FK_CSTMR_TO_CSTMR_AUTH FOREIGN KEY (CUSTOMER_ID)
REFERENCES CUSTOMER (CUSTOMER_ID)
ON DELETE CASCADE;

ALTER TABLE MODEL_RATING
ADD CONSTRAINT FK_CSTMR_TO_MDL_RATING FOREIGN KEY (CUSTOMER_ID)
REFERENCES CUSTOMER (CUSTOMER_ID)
ON DELETE CASCADE;
...
ADD CONSTRAINT FK_VST_TO_VST_REPAIR FOREIGN KEY (VISIT_ID)
REFERENCES VISIT (VISIT_ID)
ON DELETE CASCADE;

ALTER TABLE CUSTOMER_ADDRESS ADD CONSTRAINT FK_CSTMR_TO_CSTMR_ADDRESS FOREIGN KEY (CUSTOMER_ID)
REFERENCES CUSTOMER (CUSTOMER_ID)
ON DELETE CASCADE;

ALTER TABLE REQUEST
ADD CONSTRAINT FK_SUB_TO_REQUEST FOREIGN KEY (SUBSCRIPTION_ID)
...
ALTER TABLE VISIT
ADD CONSTRAINT FK_REQUEST_TO_VISIT FOREIGN KEY (REQUEST_ID)
REFERENCES REQUEST (REQUEST_ID)
ON DELETE CASCADE;

ALTER TABLE SUBSCRIPTION
ADD CONSTRAINT FK_CSTMR_TO_SUBSCRIPTION FOREIGN KEY (CUSTOMER_ID)
REFERENCES CUSTOMER (CUSTOMER_ID)
ON DELETE CASCADE;
...
ADD CONSTRAINT FK_RQ_TO_RQ_PREFERENCE_DATE FOREIGN KEY (REQUEST_ID)
REFERENCES REQUEST (REQUEST_ID)
ON DELETE CASCADE;
...
INSERT INTO MODEL (MODEL_ID, MODEL_NAME, MODEL_TYPE, YEARLY_FEE, MANUFACTURER, COLOR, ENERGY_RATING, RELEASE_YEAR) VALUES
(5, 'Dyson PureCool', '공기청정기', 760000, 'Dyson', '실버', 1, 2023);
INSERT INTO MODEL (MODEL_ID, MODEL_NAME, MODEL_TYPE, YEARLY_FEE, MANUFACTURER, COLOR, ENERGY_RATING, RELEASE_YEAR) VALUES
...
INSERT INTO MODEL (MODEL_ID, MODEL_NAME, MODEL_TYPE, YEARLY_FEE, MANUFACTURER, COLOR, ENERGY_RATING, RELEASE_YEAR) VALUES
(17, 'Samsung Neo QLED', 'TV', 1760000, 'Samsung', '블랙', 1, 2022);
INSERT INTO MODEL (MODEL_ID, MODEL_NAME, MODEL_TYPE, YEARLY_FEE, MANUFACTURER, COLOR, ENERGY_RATING, RELEASE_YEAR) VALUES
...
INSERT INTO MODEL (MODEL_ID, MODEL_NAME, MODEL_TYPE, YEARLY_FEE, MANUFACTURER, COLOR, ENERGY_RATING, RELEASE_YEAR) VALUES
(22, 'Sony OLED Pro', 'TV', 1660000, 'Sony', '블랙', 1, 2023);
INSERT INTO MODEL (MODEL_ID, MODEL_NAME, MODEL_TYPE, YEARLY_FEE, MANUFACTURER, COLOR, ENERGY_RATING, RELEASE_YEAR) VALUES
