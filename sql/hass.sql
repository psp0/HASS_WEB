...
CREATE TABLE SUBSCRIPTION (
    "SUBSCRIPTION_ID" NUMBER(10) NOT NULL,
    "SUBSCRIPTION_YEAR" NUMBER(1) NULL,
    "DATE_CREATED" DATE NOT NULL,
...
(1, 'kimcs', '$2y$10$NIy34vs1bo5O6jAwTNf74eE4IK4Nh5xKMaL3A6WRbknx9LflIjt3O', NULL);
INSERT INTO CUSTOMER_AUTH (CUSTOMER_ID, AUTH_ID, PW_HASH, DATE_EDITED) VALUES
(2, 'leeyh', '$2y$10$8Z971F..cEgiGudtFkjGHuKm0lV5Z9ERrkpnm7ZTXx84bPTxzGvKi', NULL);
INSERT INTO CUSTOMER_AUTH (CUSTOMER_ID, AUTH_ID, PW_HASH, DATE_EDITED) VALUES
(3, 'Jien', '$2y$10$fvf.8.t61yBz.T9WQyMR4e9btuwWkTb94i0K1w00.ygO06G4A9dw6', NULL);
INSERT INTO CUSTOMER_AUTH (CUSTOMER_ID, AUTH_ID, PW_HASH, DATE_EDITED) VALUES
(4, 'ohohoh', '$2y$10$xXh9Lja3Kir1S40gwl6VUO0Ns7eol/5DToex1EZR/F9y50RYQeLh2', NULL);
INSERT INTO CUSTOMER_AUTH (CUSTOMER_ID, AUTH_ID, PW_HASH, DATE_EDITED) VALUES
(5, 'kms', '$2y$10$4QvwG9hAVnFcbbkCgaJuFe0gWZW4rADyHkUseEIw8C6LUp.VJaAfu', NULL);
INSERT INTO CUSTOMER_AUTH (CUSTOMER_ID, AUTH_ID, PW_HASH, DATE_EDITED) VALUES
(6, 'leeje', '$2y$10$Pmp9ayvexQaOVcu5ilJ5jO7WIGLSd93BqiC7eTnN1dzRNlvT5WEDi', NULL);

-- 기사 정보
INSERT INTO WORKER (WORKER_ID, WORKER_NAME,WORKER_SPECIALTY, PHONE_NUMBER) VALUES
...
('best_worker', '$2y$10$WTowtABnNsjmTd3ISdXeZOVJ3qYRX5OohH8..rzbuYEMRoRNEorIC');

-- 회사 인증 정보
INSERT INTO COMPANY_AUTH (AUTH_ID, PW_HASH) VALUES
('we_work', '$2y$10$BvqV8ZX4bcGbYUSJbEDjXut3tCBF1tXy.FCOFjkjIOLIpQOnyM52q');

-- 모델 정보
INSERT INTO MODEL (MODEL_ID, MODEL_NAME, MANUFACTURER, MODEL_TYPE, RELEASE_YEAR, YEARLY_FEE) VALUES
(1, 'Samsung UltraWash', 'Samsung', '세탁기', 2022, 50000);
INSERT INTO MODEL (MODEL_ID, MODEL_NAME, MANUFACTURER, MODEL_TYPE, RELEASE_YEAR, YEARLY_FEE) VALUES
(2, 'LG Smart TV', 'LG', 'TV', 2021, 100000);
INSERT INTO MODEL (MODEL_ID, MODEL_NAME, MANUFACTURER, MODEL_TYPE, RELEASE_YEAR, YEARLY_FEE) VALUES
(3, 'Samsung AirCleaner', 'Samsung', '공기청정기', 2023, 200000);
INSERT INTO MODEL (MODEL_ID, MODEL_NAME, MANUFACTURER, MODEL_TYPE, RELEASE_YEAR, YEARLY_FEE) VALUES
(4, 'LG Dryer', 'LG', '건조기', 2023, 150000);
INSERT INTO MODEL (MODEL_ID, MODEL_NAME, MANUFACTURER, MODEL_TYPE, RELEASE_YEAR, YEARLY_FEE) VALUES
(5, 'Dyson PureCool', 'Dyson', '공기청정기', 2023, 220000);
INSERT INTO MODEL (MODEL_ID, MODEL_NAME, MANUFACTURER, MODEL_TYPE, RELEASE_YEAR, YEARLY_FEE) VALUES
(6, 'Samsung SmartDry', 'Samsung', '건조기', 2022, 180000);
INSERT INTO MODEL (MODEL_ID, MODEL_NAME, MANUFACTURER, MODEL_TYPE, RELEASE_YEAR, YEARLY_FEE) VALUES
(7, 'LG Mini Washer', 'LG', '세탁기', 2021, 80000);
INSERT INTO MODEL (MODEL_ID, MODEL_NAME, MANUFACTURER, MODEL_TYPE, RELEASE_YEAR, YEARLY_FEE) VALUES
(8, 'LG OLED TV', 'LG', 'TV', 2022, 120000);

-- 모델 공통 사양
INSERT INTO MODEL_COMMON_SPEC (MODEL_ID, MODEL_WEIGHT, MODEL_WIDTH, MODEL_LENGTH, MODEL_HEIGHT, ENERGY_RATING, COLOR) VALUES
(1, 80.0, 60.0, 60.0, 85.0, 'A++', '화이트');
INSERT INTO MODEL_COMMON_SPEC (MODEL_ID, MODEL_WEIGHT, MODEL_WIDTH, MODEL_LENGTH, MODEL_HEIGHT, ENERGY_RATING, COLOR) VALUES
(2, 15.0, 122.5, 5.0, 70.0, 'B', '블랙');
INSERT INTO MODEL_COMMON_SPEC (MODEL_ID, MODEL_WEIGHT, MODEL_WIDTH, MODEL_LENGTH, MODEL_HEIGHT, ENERGY_RATING, COLOR) VALUES
(3, 10.0, 30.0, 30.0, 50.0, 'A', '화이트');
INSERT INTO MODEL_COMMON_SPEC (MODEL_ID, MODEL_WEIGHT, MODEL_WIDTH, MODEL_LENGTH, MODEL_HEIGHT, ENERGY_RATING, COLOR) VALUES
(4, 25.0, 60.0, 60.0, 85.0, 'A+', '실버');
INSERT INTO MODEL_COMMON_SPEC (MODEL_ID, MODEL_WEIGHT, MODEL_WIDTH, MODEL_LENGTH, MODEL_HEIGHT, ENERGY_RATING, COLOR) VALUES
(5, 5.0, 30.0, 30.0, 50.0, 'A++', '화이트');
INSERT INTO MODEL_COMMON_SPEC (MODEL_ID, MODEL_WEIGHT, MODEL_WIDTH, MODEL_LENGTH, MODEL_HEIGHT, ENERGY_RATING, COLOR) VALUES
(6, 30.0, 60.0, 60.0, 85.0, 'A', '화이트');
INSERT INTO MODEL_COMMON_SPEC (MODEL_ID, MODEL_WEIGHT, MODEL_WIDTH, MODEL_LENGTH, MODEL_HEIGHT, ENERGY_RATING, COLOR) VALUES
(7, 10.0, 30.0, 30.0, 50.0, 'A++', '화이트');
INSERT INTO MODEL_COMMON_SPEC (MODEL_ID, MODEL_WEIGHT, MODEL_WIDTH, MODEL_LENGTH, MODEL_HEIGHT, ENERGY_RATING, COLOR) VALUES
(8, 15.0, 122.5, 5.0, 70.0, 'B', '블랙');

-- 모델 세탁기 사양
INSERT INTO MODEL_WASHING_SPEC (MODEL_ID, WASHER_TYPE, CAPACITY_KG) VALUES
(1, '드럼', 10.0);
INSERT INTO MODEL_WASHING_SPEC (MODEL_ID, WASHER_TYPE, CAPACITY_KG) VALUES
(7, '미니', 3.5);
...
-- 방문 정보
INSERT INTO VISIT (VISIT_ID, VISIT_TYPE, VISIT_STATUS, VISIT_DATE, DATE_CREATED, WORKER_ID, REQUEST_ID) VALUES
(1, '설치', '방문완료', TO_TIMESTAMP('2022-10-20 14:00:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2022-10-16 09:00:00', 'YYYY-MM-DD HH24:MI:SS'), 1, 1);
INSERT INTO VISIT (VISIT_ID, VISIT_TYPE, VISIT_STATUS, VISIT_DATE, DATE_CREATED, WORKER_ID, REQUEST_ID) VALUES
(2, '수리', '방문완료', TO_TIMESTAMP('2022-11-16 11:00:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2022-11-15 15:00:00', 'YYYY-MM-DD HH24:MI:SS'), 5, 2);
INSERT INTO VISIT (VISIT_ID, VISIT_TYPE, VISIT_STATUS, VISIT_DATE, DATE_CREATED, WORKER_ID, REQUEST_ID) VALUES
(3, '설치', '방문완료', TO_TIMESTAMP('2023-10-25 11:00:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2023-10-16 11:00:00', 'YYYY-MM-DD HH24:MI:SS'), 2, 3);
INSERT INTO VISIT (VISIT_ID, VISIT_TYPE, VISIT_STATUS, VISIT_DATE, DATE_CREATED, WORKER_ID, REQUEST_ID) VALUES
(4, '설치', '방문완료', TO_TIMESTAMP('2023-11-16 13:00:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2023-10-16 13:00:00', 'YYYY-MM-DD HH24:MI:SS'), 3, 4);
INSERT INTO VISIT (VISIT_ID, VISIT_TYPE, VISIT_STATUS, VISIT_DATE, DATE_CREATED, WORKER_ID, REQUEST_ID) VALUES
(5, '설치', '방문완료', TO_TIMESTAMP('2023-10-17 15:00:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2023-10-16 15:00:00', 'YYYY-MM-DD HH24:MI:SS'), 4, 5);
INSERT INTO VISIT (VISIT_ID, VISIT_TYPE, VISIT_STATUS, VISIT_DATE, DATE_CREATED, WORKER_ID, REQUEST_ID) VALUES
(6, '회수', '방문완료', TO_TIMESTAMP('2023-10-21 11:00:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2023-10-20 15:30:00', 'YYYY-MM-DD HH24:MI:SS'), 9, 6);
INSERT INTO VISIT (VISIT_ID, VISIT_TYPE, VISIT_STATUS, VISIT_DATE, DATE_CREATED, WORKER_ID, REQUEST_ID) VALUES
(7, '설치', '방문완료', TO_TIMESTAMP('2023-10-25 15:00:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2023-10-21 15:00:00', 'YYYY-MM-DD HH24:MI:SS'), 5, 7);
INSERT INTO VISIT (VISIT_ID, VISIT_TYPE, VISIT_STATUS, VISIT_DATE, DATE_CREATED, WORKER_ID, REQUEST_ID) VALUES
(8, '수리', '방문완료', TO_TIMESTAMP('2023-10-30 12:00:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2023-10-20 15:30:00', 'YYYY-MM-DD HH24:MI:SS'), 4, 8);
INSERT INTO VISIT (VISIT_ID, VISIT_TYPE, VISIT_STATUS, VISIT_DATE, DATE_CREATED, WORKER_ID, REQUEST_ID) VALUES
(9, '회수', '방문완료', TO_TIMESTAMP('2024-10-20 12:00:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2024-10-19 08:00:00', 'YYYY-MM-DD HH24:MI:SS'), 8, 9);
INSERT INTO VISIT (VISIT_ID, VISIT_TYPE, VISIT_STATUS, VISIT_DATE, DATE_CREATED, WORKER_ID, REQUEST_ID) VALUES
(10, '설치', '방문예정', TO_TIMESTAMP('2024-11-14 12:00:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2024-11-04 08:00:00', 'YYYY-MM-DD HH24:MI:SS'), 7, 11);
