...
<div class="container">
    ...
    <form method="GET" action="" class="form-container">
        ...
        <div>
            ...
            <select name="productStatus" id="productStatus" class="select-field">
        ...
        <div class="flex-1">
            ...
            <input type="text" name="serialNumber" id="serialNumber" placeholder="시리얼번호 검색"
                value="<?= htmlspecialchars($serialNumber) ?>" class="input-field">
        </div>
        <button type="submit" class="button">검색</button>
        <button type="reset" class="button-small" onclick="location.href='product.php'">초기화</button>
    </form>
