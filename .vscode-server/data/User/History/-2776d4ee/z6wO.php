...
<style>
    ...
    .button {
        @apply mt-6 bg-blue-500 text-white px-5 py-3 rounded-md shadow-sm;
    }

    .reset-button {
        @apply mt-6 bg-blue-500 text-white px-2 py-1 rounded-md shadow-sm;
    }

    .product-card {
        @apply space-y-4 mb-6 bg-gray-50 p-4 rounded-lg shadow-sm flex items-center gap-5;
    }
    ...
    .section-title {
        @apply text-blue-500 font-bold text-xl mb-2;
    }

    .no-product-message {
        @apply text-2xl font-bold text-red-500 text-center mt-5;
    }
</style>
