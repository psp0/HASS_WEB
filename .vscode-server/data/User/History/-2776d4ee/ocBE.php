...
<div class="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-md">
    ...
    var_dump($config['username'], $config['password'], $config['host'], $config['port'], $config['sid']);
    ...
    ?>
        ...
        <div class="space-y-4 mb-6">
            <div class="bg-gray-50 p-4 rounded-lg shadow-sm product-info">
                ...
                <div class="buttons">
                    <button class="text-blue-500 hover:underline" onclick="toggleDetails('subscription<?= $serial ?>')">구독기록</button>
                    <button class="text-blue-500 hover:underline" onclick="toggleDetails('repair<?= $serial ?>')">수리기록</button>
                </div>
            </div>
