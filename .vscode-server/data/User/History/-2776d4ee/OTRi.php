    ...
    <style>
        ...
        .buttons {
         ...
         .section-title {
            color: #1D4ED8; /* 파란색 */
            font-weight: bold;
            font-size: 1.25rem; /* 텍스트 크기를 약간 키움 */
            ...
            <div class="space-y-4 mb-6">
                <div class="bg-gray-50 p-4 rounded-lg shadow-sm product-info">
                    ...
                    <div class="product-details">
                        ...
                        <p><strong>모델 ID:</strong> <?= $modelId ?> <span class="text-gray-600">- <?= $modelName ?></span>
                        </p>
                ...
                <div id="subscription<?= $serial ?>" class="hidden mt-4">
                    <h2 class="text-lg font-bold mb-2">구독 기록</h2>
                        ...
                        <tbody>
                            <?php while ($subscription = oci_fetch_array($subscriptionStmt, OCI_ASSOC + OCI_RETURN_NULLS)) { ?>
                                <tr>
                                    ...
                                    <td class="border px-4 py-2"><?= date('Y-m-d', strtotime($subscription['BEGIN_DATE'])) ?>
                                    </td>
                                    <td class="border px-4 py-2"><?= date('Y-m-d', strtotime($subscription['EXPIRED_DATE'])) ?>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
                ...
                <div id="repair<?= $serial ?>" class="hidden mt-4">
                    <h2 class="text-lg font-bold mb-2">수리 기록</h2>
                    <table class="min-w-full bg-white">
                        <thead>
                            <tr>
