...
<body>
  ...
  <div class="main-container">
    <div class="filter-panel">
      <div class="accordion active">건조용량</div>
      <div class="panel" style="max-height: 1000px;">
        <div class="checkbox-group">
          <label><input type="checkbox" value="21kg">21KG 이상</label>
          <label><input type="checkbox" value="11-20kg">11~20KG</label>
          <label><input type="checkbox" value="10kg">10KG 이하</label>
        </div>
      </div>

      <div class="accordion active">설치 방식</div>
      <div class="panel" style="max-height: 1000px;">
        <div class="checkbox-group">
          <label><input type="checkbox" value="gas">가스식</label>
          <label><input type="checkbox" value="electric">전기식</label>
        </div>
      </div>

      <div class="accordion active">건조 방식</div>
      <div class="panel" style="max-height: 1000px;">
        <div class="checkbox-group">
          <label><input type="checkbox" value="heater">히터식</label>
          <label><input type="checkbox" value="heat-pump">히트펌프식</label>
          <label><input type="checkbox" value="inverter-heat-pump">인버터 히트펌프</label>
        </div>
      </div>

      <div class="accordion active">배기 방식</div>
      <div class="panel" style="max-height: 1000px;">
        <div class="checkbox-group">
          <label><input type="checkbox" value="direct-vent">직접 배기 방식</label>
          <label><input type="checkbox" value="condensing">콘덴싱 배수 방식</label>
        </div>
      </div>
