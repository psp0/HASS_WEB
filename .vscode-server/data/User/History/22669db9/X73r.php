...
<body>
  ...
  <div class="main-container">
    <div class="filter-panel">
      ...
      <div style="padding: 10px;">
        ...
        <input type="range" min="10000" max="100000" value="53900" class="slider" id="subscription-slider">
        <p>Value: <span id="subscription-value"></span></p>
      </div>
  ...
  <script>
    ...
    var slider = document.getElementById("subscription-slider");
    var output = document.getElementById("subscription-value");
