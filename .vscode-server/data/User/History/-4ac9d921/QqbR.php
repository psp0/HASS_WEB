...
<div class="data-container">
    ...
    TO_CHAR(REQUEST.DATE_CREATED, 'YYYY-MM-DD HH24:MI') AS DATE_CREATED
FROM REQUEST
...
ORDER BY REQUEST.DATE_CREATED DESC";
    ...
    REQUEST.REQUEST_TYPE,
    TO_CHAR((SELECT VISIT_DATE FROM VISIT WHERE REQUEST.REQUEST_ID = VISIT.REQUEST_ID), 'YYYY-MM-DD HH24:MI') AS VISIT_DATE,
