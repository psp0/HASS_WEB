...
<div class="rating-score-container">
    <div class="rating-score"><?= htmlspecialchars($ratingData['AVG_RATING'] ?? 0) ?></div>
    <div class="stars"><?= str_repeat('★', round($ratingData['AVG_RATING'] ?? 0)) ?></div>
</div>
    ...
    while ($row = oci_fetch_array($stmt, OCI_ASSOC + OCI_RETURN_NULLS)) {
        ...
        <div class="review-item">
            <div class="review-details">
                ...
                <span class="review-author-date"><?= htmlspecialchars($row['CUSTOMER_NAME']) ?> | <?= htmlspecialchars($row['DATE_CREATED']) ?></span>
            </div>
