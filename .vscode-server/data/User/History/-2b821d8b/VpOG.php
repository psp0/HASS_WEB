...
<div class="signup-container">
        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
            ...
            <a href="<?php echo TEAM_PATH; ?>/pages/login/worker_login.php" button type="submit">회원가입</a><button type="submit">회원가입</button>
        </form>
...
<div class="signup-container">
    ...
    $queryC = "INSERT INTO CUSTOMER_ADDRESS(CUSTOMER_ID, STREET_ADDRESS, DETAILED_ADDRESS, POSTAL_CODE) VALUES (:customer_id, :road_address, :detail_address, :psotal_code)";
