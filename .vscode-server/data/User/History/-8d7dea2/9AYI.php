  ...
  <div class="modal-content">
    ...
    <form id="subscription-form">
      ...
      <div class="mb-4 text-left">
        ...
        <input type="text" id="datetime-picker" class="w-full px-3 py-2 border rounded-lg" placeholder="날짜와 시간을 선택하세요">
      </div>
  ...
  <script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
      flatpickr("#datetime-picker", {
        ...
        minuteIncrement: 1, // 분 단위 선택 증가값
        defaultDate: new Date(), // 현재 날짜 및 시간 기본값
        onChange: function (selectedDates, dateStr, instance) {
          console.log("선택된 날짜 및 시간:", dateStr);
        },
      });
    });
