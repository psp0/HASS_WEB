  ...
  <script>
    ...
    document.querySelectorAll(".review-button").forEach((button) => {
      button.addEventListener("click", async (e) => {
        ...
        document.querySelector(".filter-panel").style.backgroundColor = "rgba(255, 255, 255, 0.5)"; // 배경을 반투명하게 설정
    ...
    closeModal.addEventListener("click", () => {
      ...
      document.querySelector(".filter-panel").style.backgroundColor = ""; // 원래 배경 색상으로 복원
