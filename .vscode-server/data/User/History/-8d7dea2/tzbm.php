...
// 모달 열기 시 필터 비활성화
function disableFilterPanel() {
  filterPanel.classList.add("inactive");
  document.body.style.overflow = "hidden"; // 스크롤 비활성화
}

// 모달 닫기 시 필터 활성화
function enableFilterPanel() {
  filterPanel.classList.remove("inactive");
...
// 구독 신청 모달 닫기
document.getElementById("close-subscription").addEventListener("click", () => {
