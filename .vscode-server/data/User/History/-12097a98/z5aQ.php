...
<body class="bg-gray-100 p-6">
    <div class="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        <!-- Filter Panel -->
        <div class="col-span-1 bg-white p-4 rounded-lg shadow-md">
            <h3 class="text-lg font-bold mb-4">필터</h3>
            <div class="mb-4">
                <button class="accordion w-full text-left font-semibold">필터 종류</button>
                <div class="panel mt-2 hidden">
                    <label class="block text-sm mb-1"><input type="checkbox"> 판형</label>
                    <label class="block text-sm"><input type="checkbox"> 원통형</label>
                </div>
            </div>
            <div class="mb-4">
                <button class="accordion w-full text-left font-semibold">PM 센서</button>
                <div class="panel mt-2 hidden">
                    <label class="block text-sm mb-1"><input type="checkbox"> PM10</label>
                    <label class="block text-sm mb-1"><input type="checkbox"> PM2.5</label>
                    <label class="block text-sm"><input type="checkbox"> PM1</label>
                </div>
            </div>
            <div class="mb-4">
                <button class="accordion w-full text-left font-semibold">필터 등급</button>
                <div class="panel mt-2 hidden">
                    <label class="block text-sm mb-1"><input type="checkbox"> H13</label>
                    <label class="block text-sm"><input type="checkbox"> H14</label>
                </div>
            </div>
        </div>
        <!-- Product List -->
