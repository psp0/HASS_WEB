...
function showModal(requestId, modelId, requestType, requestStatus, visitDate) {
    ...
    document.getElementById('modalModelId').innerText = "모델 ID: " + modelId;
    document.getElementById('modalRequestType').innerText = "요청 종류: " + requestType;
    document.getElementById('modalRequestStatus').innerText = "요청 상태: " + requestStatus;
    document.getElementById('modalVisitDate').innerText = "방문 (선호) 일자: " + visitDate;
