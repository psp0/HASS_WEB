...
<script>
// Function to show the modal and populate the fields with data
function showModal(requestId, modelId, requestType, requestStatus, visitDate) {
    // Set the modal content
    document.getElementById('modalRequestId').innerText = "Request ID: " + requestId;
    document.getElementById('modalModelId').innerText = "Model ID: " + modelId;
    document.getElementById('modalRequestType').innerText = "Request Type: " + requestType;
    document.getElementById('modalRequestStatus').innerText = "Request Status: " + requestStatus;
    document.getElementById('modalVisitDate').innerText = "Visit Date: " + visitDate;
