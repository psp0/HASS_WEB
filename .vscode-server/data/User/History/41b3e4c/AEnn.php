...
if ($requestId) {
    ...
    $queryD = "SELECT WORKER.ID,WORKER_NAME FROM WORKER WHERE WORKER_ID = (SELECT WORKER_ID FROM VISIT WHERE REQUEST_ID = :REQUEST_ID)";
    ...
    if ($requestData && $customerData) {
        ...
        echo "<p class='error'>요청 정보 또는 고객 정보를 찾을 수 없습니다.</p>";
    }
