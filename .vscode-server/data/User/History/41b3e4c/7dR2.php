    ...
    <?php if ($visitData): ?>
        <table>
            ...
            if ($requestStatus === '대기중') {
                if (is_array($visitData) && count($visitData) >= 1) {
                    if (count($visitData) == 2) {
                        echo "<tr><th rowspan=2>선호 날짜</th><td>" . htmlspecialchars($visitData[0]['PREFER_DATE']) . "</td></tr>";
                        echo "<tr><td>" . htmlspecialchars($visitData[1]['PREFER_DATE']) . "</td></tr>";
                    } else {
