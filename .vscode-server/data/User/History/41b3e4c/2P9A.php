...
if ($requestId) {
    ...
    if ($customerData) {
        ...
        echo "<tr><th>메인 전화번호</th><td>" . htmlspecialchars($customerData['MAIN_PHONE_NUMBER']) . "</td></tr>";
        echo "<tr><th>서브 전화번호</th><td>" . htmlspecialchars($customerData['SUB_PHONE_NUMBER']) . "</td></tr>";
        echo "<tr><th>주소</th><td>" . htmlspecialchars($customerData['CUSTOMER_ADDRESS']) . "</td></tr>";
        echo "<tr><th>회원가입일</th><td>" . htmlspecialchars($customerData['DATE_CREATED']) . "</td></tr>";
        echo "<tr><th>정보수정일</th><td>" . htmlspecialchars($customerData['DATE_EDITED']) . "</td></tr>";
        echo "</table>";
    }
