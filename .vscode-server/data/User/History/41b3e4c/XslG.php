...
if ($requestId) {
    ...
    if ($e = oci_error($stmtD)) {
        echo "<p class='error'>OCI 실행 오류: " . $e['message'] . "</p>";
    }
    ...
    if ($requestData ){
       ...
       if($workerData){
        echo "<h3>작업자 정보</h3>";
        echo "<table border='1'>";
        echo "<tr><th>작업자 ID</th><td>" . htmlspecialchars($workerData['WORKER_ID']) . "</td></tr>";
        echo "<tr><th>작업자 이름</th><td>" . htmlspecialchars($workerData['WORKER_NAME']) . "</td></tr>";
        echo "</table>";
