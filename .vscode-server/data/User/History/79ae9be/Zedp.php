...
<div class="main-container">
    ...
    <div class="model-container" id="model-container">
      <div class="data-container">
        ...
        if (!empty($_GET['yearly_fee_min']) && !empty($_GET['yearly_fee_max'])) {
          $yearly_fee_min = isset($_GET['yearly_fee_min']) ? (int) $_GET['yearly_fee_min'] : $minFee;
          $yearly_fee_max = isset($_GET['yearly_fee_max']) ? (int) $_GET['yearly_fee_max'] : $maxFee;
  ...
  <script>
    ...
    var startMin = <?php echo json_encode($yearly_fee_min); ?>;
    var startMax = <?php echo json_encode($yearly_fee_max); ?>;
