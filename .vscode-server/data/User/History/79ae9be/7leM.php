    ...
    <form id="subscription-form">
      ...
      <div class="mb-4 text-left">
        ...
        <div class="flex items-center mb-2">
          ...
          <input type="datetime-local" id="visit-date-1" class="w-full px-3 py-2 border rounded-lg">
        </div>
    ...
    <div class="model-container" id="model-container">
      <div class="data-container">
        ...
        while ($row = oci_fetch_array($stmt, OCI_ASSOC + OCI_RETURN_NULLS)) {
          ...
          echo "<button class='review-button ml-2 text-sm text-blue-600 border border-blue-600 rounded px-2 py-1' data-model-id='" . htmlspecialchars($row['MODEL_ID']) . "'>리뷰 보기</button>";
          ...
          echo "<button class='w-full bg-blue-600 text-white font-bold py-2 rounded-lg subscription-button' data-model-id='" . htmlspecialchars($row['MODEL_ID']) . "'>구독 신청</button>";
          echo "</div>";
        }
