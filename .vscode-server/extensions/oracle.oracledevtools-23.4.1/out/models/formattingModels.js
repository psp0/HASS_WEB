...
exports.FormatTextCancelRequest = exports.FormatTextRequest = exports.FormatTextResponse = exports.FormatTextRequestParam = exports.FormatType = exports.FormatOptions = exports.WhiteSpaceSetting = exports.SingleLineCommentFormatType = exports.IfCaseWhileFormatType = exports.LineBreakPosition = void 0;
...
(function (WhiteSpaceSetting) {
    ...
    WhiteSpaceSetting[WhiteSpaceSetting["InsideAndOutsideBrackets"] = 5] = "InsideAndOutsideBrackets";
...
class FormatOptions {
    constructor() {
        ...
        this.commasPerLine = 1;
        this.spacesInsideParenthesis = 1;
        this.spacesOutsideParenthesis = 1;
...
class FormatTextCancelRequest {
}
exports.FormatTextCancelRequest = FormatTextCancelRequest;
FormatTextCancelRequest.type = new vscode_languageclient_1.RequestType(constants_1.Constants.formatDocumentCancelRequest);
