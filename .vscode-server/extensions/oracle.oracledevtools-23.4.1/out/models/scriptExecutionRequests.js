...
exports.GetOverflowDataRequest = exports.SortAndFilterRequest = exports.RerunQueryRequest = exports.OracleNotificationTypes = exports.CodeObjectOutputEvent = exports.OracleRequestTypes = void 0;
...
OracleNotificationTypes.scriptExecutionDataFetchedEvent = new vscode_jsonrpc_1.NotificationType(scriptExecutionModels_1.OracleEventNames.scriptExecutionDataFetched);
OracleNotificationTypes.generateSQLFromNLDataEvent = new vscode_jsonrpc_1.NotificationType(scriptExecutionModels_1.OracleEventNames.generateSQLFromNLScriptExecutionDataEvent);
OracleNotificationTypes.generateSQLFromNLErrorEvent = new vscode_jsonrpc_1.NotificationType(scriptExecutionModels_1.OracleEventNames.generateSQLFromNLErrorEvent);
class RerunQueryRequest {
}
exports.RerunQueryRequest = RerunQueryRequest;
RerunQueryRequest.type = new vscode_jsonrpc_1.RequestType(scriptExecutionModels_1.MessageName.rerunQueryRequest);
class SortAndFilterRequest {
}
exports.SortAndFilterRequest = SortAndFilterRequest;
SortAndFilterRequest.type = new vscode_jsonrpc_1.RequestType(scriptExecutionModels_1.MessageName.sortAndFilterRequest);
class GetOverflowDataRequest {
}
exports.GetOverflowDataRequest = GetOverflowDataRequest;
GetOverflowDataRequest.type = new vscode_jsonrpc_1.RequestType(scriptExecutionModels_1.MessageName.overflowDataRequest);
