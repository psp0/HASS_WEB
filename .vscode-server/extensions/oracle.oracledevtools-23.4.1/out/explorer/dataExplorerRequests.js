...
class DataExplorerEditorClosedEventParams {
}
exports.DataExplorerEditorClosedEventParams = DataExplorerEditorClosedEventParams;
class DataExplorerEditorClosedEvent {
}
exports.DataExplorerEditorClosedEvent = DataExplorerEditorClosedEvent;
DataExplorerEditorClosedEvent.event = new vscode_languageclient_1.NotificationType(constants_1.Constants.dataExplorerEditorClosedEventName);
...
class DataExploreShowObjectDataParams {
    constructor() {
        this.showDataFetchSize = 0;
    }
}
exports.DataExploreShowObjectDataParams = DataExploreShowObjectDataParams;
...
class ResolveHostnameRequestParams {
}
exports.ResolveHostnameRequestParams = ResolveHostnameRequestParams;
class ResolveHostnameResponse extends PlsqlValidateSettingsResponse {
}
exports.ResolveHostnameResponse = ResolveHostnameResponse;
class ResolveHostnameRequest {
}
exports.ResolveHostnameRequest = ResolveHostnameRequest;
ResolveHostnameRequest.type = new vscode_languageclient_1.RequestType(constants_1.Constants.plsqlDebugResolveHostnameRequest);
