...
class PackageBodyNode extends databaseObjectBasic_1.DatabaseObjectBasic {
    ...
    async getChildren() {
        ...
        let specMethodNodes = await utilities_1.ExplorerUtilities.getChildNodes(this, dataExplorerRequests_1.OracleDDEXObjectTypes.OraDDEX_PackageBodyMethod, restrictions);
        let methodNodes = await utilities_1.ExplorerUtilities.getChildNodes(this, dataExplorerRequests_1.OracleDDEXObjectTypes.OraDDEX_PackageBodyPrivateMethod, restrictions);
