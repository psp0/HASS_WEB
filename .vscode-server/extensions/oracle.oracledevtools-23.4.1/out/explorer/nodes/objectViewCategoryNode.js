...
exports.ObjectViewCategoryNode = void 0;
...
class ObjectViewCategoryNode extends databaseObjectBasic_1.CategoryNodeBase {
    constructor(connURI, parentPath, schemaName) {
        super(connURI, parentPath, utilities_1.TreeViewConstants.objectViewsStr, utilities_1.TreeViewConstants.objectViewsStr, schemaName);
    }
    async getChildren() {
        return new Promise(async (resolve, reject) => {
            try {
                if (!this.children) {
                    ...
                    this.children = await utilities_1.ExplorerUtilities.getChildNodes(this, dataExplorerRequests_1.OracleDDEXObjectTypes.OraDDEX_ObjectView, restrictions);
                }
...
exports.ObjectViewCategoryNode = ObjectViewCategoryNode;
