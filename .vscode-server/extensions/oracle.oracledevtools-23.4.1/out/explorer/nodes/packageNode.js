...
class PackageNode extends databaseObjectBasic_1.DatabaseObjectBasic {
    ...
    async getChildren() {
        ...
        let bodyNodes = await utilities_1.ExplorerUtilities.getChildNodes(this, dataExplorerRequests_1.OracleDDEXObjectTypes.OraDDEX_PackageBody, restrictions);
        ...
        let methodNodes = await utilities_1.ExplorerUtilities.getChildNodes(this, dataExplorerRequests_1.OracleDDEXObjectTypes.OraDDEX_PackageMethod, restrictions);
        if (methodNodes) {
