...
exports.ObjectTableCategoryNode = void 0;
...
class ObjectTableCategoryNode extends databaseObjectBasic_1.CategoryNodeBase {
    constructor(connURI, parentPath, schemaName) {
        super(connURI, parentPath, utilities_1.TreeViewConstants.objectTablesStr, utilities_1.TreeViewConstants.objectTablesStr, schemaName);
    }
    async getChildren() {
        return new Promise(async (resolve, reject) => {
            try {
                if (!this.children) {
                    ...
                    this.children = await utilities_1.ExplorerUtilities.getChildNodes(this, dataExplorerRequests_1.OracleDDEXObjectTypes.OraDDEX_ObjectTable, restrictions);
                }
...
exports.ObjectTableCategoryNode = ObjectTableCategoryNode;
