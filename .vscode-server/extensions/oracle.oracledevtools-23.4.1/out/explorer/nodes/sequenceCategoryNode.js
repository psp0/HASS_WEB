...
exports.SequenceCategoryNode = void 0;
...
class SequenceCategoryNode extends databaseObjectBasic_1.CategoryNodeBase {
    constructor(connURI, parentPath, schemaName) {
        super(connURI, parentPath, utilities_1.TreeViewConstants.sequencesStr, utilities_1.TreeViewConstants.sequencesStr, schemaName);
    }
    async getChildren() {
        return new Promise(async (resolve, reject) => {
            try {
                if (!this.children) {
                    ...
                    this.children = await utilities_1.ExplorerUtilities.getChildNodes(this, dataExplorerRequests_1.OracleDDEXObjectTypes.OraDDEX_Sequence, restrictions);
                }
...
exports.SequenceCategoryNode = SequenceCategoryNode;
