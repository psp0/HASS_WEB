...
exports.RelationalViewCategoryNode = void 0;
...
class RelationalViewCategoryNode extends databaseObjectBasic_1.CategoryNodeBase {
    constructor(connURI, parentPath, schemaName) {
        super(connURI, parentPath, utilities_1.TreeViewConstants.relationalViewsStr, utilities_1.TreeViewConstants.relationalViewsStr, schemaName);
    }
    async getChildren() {
        return new Promise(async (resolve, reject) => {
            try {
                if (!this.children) {
                    ...
                    this.children = await utilities_1.ExplorerUtilities.getChildNodes(this, dataExplorerRequests_1.OracleDDEXObjectTypes.OraDDEX_RelationalView, restrictions);
                }
...
exports.RelationalViewCategoryNode = RelationalViewCategoryNode;
