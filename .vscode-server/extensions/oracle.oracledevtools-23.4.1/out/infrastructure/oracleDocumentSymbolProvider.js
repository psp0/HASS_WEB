        ...
        return new Promise(async (resolve, reject) => {
            try {
                ...
                token.onCancellationRequested(async () => {
                    fileLogger.info("Cancellation request for document symbol information");
                    oracleLanguageServerClient_1.OracleLanguageServerClient.instance.sendRequest(codeNavigationRequests_1.SymbolInformationCancelRequest.type, new codeNavigationRequests_1.SymbolInformationParam(document.uri.toString()));
                    reject();
                });
                await this.languageServerClient.sendRequest(codeNavigationRequests_1.SymbolInformationRequest.type, new codeNavigationRequests_1.SymbolInformationParam(document.uri.toString()))
                    .then(async (result) => {
