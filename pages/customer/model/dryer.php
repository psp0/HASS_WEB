    ...
    <form id="subscription-form">
      <div class="mb-4 text-left">
        ...
        <div class="flex items-center mb-2">
          ...
          <input type="datetime-local" id="visit-date-1" name="visit_date_1"
            class="w-full px-3 py-2 border rounded-lg">
        </div>
        <div class="flex items-center">
          <span class="mr-2 font-bold">2</span>
          <input type="datetime-local" id="visit-date-2" name="visit_date_2"
            class="w-full px-3 py-2 border rounded-lg">
        </div>
      </div>
      <div class="mb-4 text-left">
      ...
      <div class="mb-4 text-left">
        ...
        <textarea id="additional-request" name="additional_request" class="w-full px-3 py-2 border rounded-lg"
          rows="4" placeholder="요청사항을 입력해주세요." maxlength="1000"></textarea>
      </div>

      <input type="hidden" id="subscription-model-id" name="model_id">
      <button type="button" id="submit-subscription"
        class="w-full bg-blue-500 text-white font-bold py-2 rounded-lg">
        신청
      </button>
    </form>
  ...
  <script>
    ...
    document.addEventListener("DOMContentLoaded", () => {
      ...
      resetButton.addEventListener('click', () => {
        window.location.href = 'dryer.php';
      });
