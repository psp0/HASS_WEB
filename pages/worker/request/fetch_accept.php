...
if (isset($workerId, $requestId)) {
    try {
        ...
        $visitQuery = "INSERT INTO VISIT (VISIT_ID, VISIT_DATE, DATE_CREATED, WORKER_ID, REQUEST_ID)
          VALUES (V_SEQ.NEXTVAL, (SELECT PREFER_DATE FROM REQUEST_PREFERENCE_DATE WHERE REQUEST_ID=:REQUEST_ID AND ROWNUM = 1), SYSDATE, :WORKER_ID, :REQUEST_ID)";
